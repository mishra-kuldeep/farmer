...
const ProductRating = ({ data }) => {
  ...
  useEffect(() => {
    if (data?.productDtlId) {
      ProductRateServices.getRatingDistributionById(data?.productDtlId)
        .then(({ data }) => {
  ...
  useEffect(() => {
    if (ratingDistribution?.ratings) {
      const percentages = Object.entries(ratingDistribution?.ratings).reduce(
        (result, [rating, count]) => {
          ...
          <div>
            <div className="d-flex align-items-center">
              ...
              <div
                ...
                style={{ "--progress": `${ratingpercentages["5"]}` }}
              >
                <div class="progress-bar"></div>
              </div>
              <span className="text-secondary ms-3">
                {ratingDistribution?.ratings["5"]}
              </span>
            </div>
            <div className="d-flex align-items-center">
              <div style={{ width: "50px" }}>
              ...
              <div
                class="review-container"
                style={{ "--progress": `${ratingpercentages["4"]}` }}
              >
                <div class="progress-bar2" data-color="green"></div>
              </div>
              <span className="text-secondary ms-3">
                {ratingDistribution?.ratings["4"]}
              </span>
            </div>
            <div className="d-flex align-items-center">
              <div style={{ width: "50px" }}>
              ...
              <div
                class="review-container"
                style={{ "--progress": `${ratingpercentages["3"]}` }}
              >
                <div class="progress-bar2" data-color="green"></div>
              </div>
              <span className="text-secondary ms-3">
                {ratingDistribution?.ratings["3"]}
              </span>
            </div>
            <div className="d-flex align-items-center">
              <div style={{ width: "50px" }}>
              ...
              <div
                class="review-container"
                style={{ "--progress": `${ratingpercentages["2"]}` }}
              >
                <div class="progress-bar2" data-color="green"></div>
              </div>
              <span className="text-secondary ms-3">
                {ratingDistribution?.ratings["2"]}
              </span>
            </div>
            <div className="d-flex align-items-center">
              <div style={{ width: "50px" }}>
              ...
              <div
                class="review-container"
                style={{ "--progress": `${ratingpercentages["1"]}` }}
              >
                <div class="progress-bar3" data-color="green"></div>
              </div>
              <span className="text-secondary ms-3">
                {ratingDistribution?.ratings["1"]}
              </span>
            </div>
          </div>
        </div>
