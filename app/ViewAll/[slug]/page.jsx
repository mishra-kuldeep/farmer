...
const Page = () => {
  ...
  }, [user?.profile?.country, country?.country?.countryId,categotyId,subcategotyId]);
    ...
    <div className="container mt-6">
      ...
      <div className="row my-4 cartParentRow">
            ...
            <div className="shopcategoryContainer">
              ...
              <ul className="viewAllList">
                <li>
                  <div
                    className={`${
                      selectedCategory == 1 && "filterSELECTED"
        ...
        <div className={showFilter ? "col-md-9" : "col-md-12"}>
          <div
            className=" viewAllcartRow  bg-light my-2 py-2 gap-4  "
