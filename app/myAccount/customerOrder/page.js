...
const Page = () => {
  ...
  const handleApprove = () => {
    ...
    VehicleMasterServices.CustomerOrderToTranspoterListToapprove(selectedId)
      .then(({ data }) => {
        console.log(data);
          ...
          {openIndex === index && (
            <div className="accordion-content">
              ...
              >
                  ...
                  onClick={() => {
                    setelectedId({
                      transporterDeliveryDetailId:
                        ele?.transporterDeliveryDetailId,
                ...
                <button className="admin_btn">Reject</button>
              </div>
            </div>
          )}
        </div>
