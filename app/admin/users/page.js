                  ...
                  {inputOpen && (
                      <div className="d-flex">
                        <div className="w-100 d-flex align-items-center gap-5">
                          <div className="w-100"><label className="adjustLabel ms-3">Remark</label>
                          <textarea
                          ...
                          ></textarea>
                           {Errors.remark && (
            <span className="error_input_text ms-3">{Errors.remark}</span>
          )}
                          </div>

                          <button className="admin_btn" onClick={()=>{setOpen2(true) 
                            setSelectedUser(ele?.UserId)
                          }}>Reject</button>
                        </div>
                      </div>
