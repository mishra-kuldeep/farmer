...
const page = () => {
  ...
  const getAllVendorApi = () => {
    ...
    if (data.countryId) {
      vendorMasterServices.getAllVendorServices(data).then(({ data }) => {
        setLoader(false);
        setVendorList(data);
      })
        .catch((err) => {
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            {singleVendorData?.cost ?
                              <td>{currencySymbol}{singleVendorData?.cost}</td> :
                              <td>--</td>
                            }
                          </tr>
                        </tbody>
            ...
            <div className='bestSellerWraper my-5 px-4'>
              <div className="headerbestSeller">
                ...
                <div className="arrowBtn_bestSeller">
                  <p className="Show_More_bestSeller" onClick={() => router.push(`/vender/${RelatedState}`)}>Show More</p>
                  <p
                ...
                : (
                  <div className="row overflowscrollhidden" ref={scrollContainerRef}>
                    {VendorList?.data?.reverse()?.map((item, i) => {
                      return (
                        <div className="col-md-3 mt-4" key={i} onClick={() => headlefulldetail(item)}>
